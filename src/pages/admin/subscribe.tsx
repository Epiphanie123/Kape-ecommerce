...
export default function SubscribePage() {
    ...
    const handleDelete = async (id: string) => {
        ...
        setDeletingId(id);
        try {
            const res = await fetch(`http://localhost:8000/api/subscribe/${id}`, {
                method: "DELETE",
            });
    ...
    return (
        <div className="p-6">
            ...
            {loading && <p>Loading...</p>}
            {error && <p className="text-blue-950">{error}</p>}
            {successMsg && <p className="text-gray-500">{successMsg}</p>}
                    ...
                    <table className="min-w-full border border-gray-200 rounded">
                        <thead className="bg-gray-100">
                            <tr>
                                ...
                                <th className="px-4 py-2 text-left text-gray-400">Subscribed At</th>
                                ...
                                <tr key={sub._id} className="border-t hover:bg-gray-50 transition">
                                    ...
                                    <td className="px-4 py-2 text-center">
                                        <button
                                            ...
                                            className="text-blue-950 hover:text-blue-900 disabled:opacity-50"
